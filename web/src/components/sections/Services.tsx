...
const services = [
  {
    ...
    description: "Keep your home consistently fresh with our weekly, bi-weekly, or monthly cleaning schedules. Perfect for busy professionals and families.",
    price: "From 50,000 Ar",
    features: ["Dusting & Polishing", "Floors & Carpets", "Kitchen & Bathrooms", "Trash Removal"],
  },
  {
    title: "Deep Cleaning",
    description: "A thorough top-to-bottom clean that reaches every nook and cranny. Ideal for spring cleaning or homes that haven't been cleaned professionally in a while.",
    price: "From 120,000 Ar",
    features: ["Inside Appliances", "Grout Scrubbing", "Window Sills & Tracks", "Baseboards & Doors"],
  },
  {
    title: "Move-In / Move-Out",
    description: "Ensure a fresh start or get your deposit back. We clean empty homes to prepare them for the next chapter.",
    price: "Custom Quote",
    features: ["Inside Cabinets", "Deep Carpet Cleaning", "Wall Spot Cleaning", "Disinfection"],
  },
];
      ...
      <Container>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {services.map((service) => (
            <div key={service.title} className="flex flex-col bg-white rounded-2xl shadow-sm border border-brand-light/20 overflow-hidden hover:shadow-lg transition-all duration-300">
